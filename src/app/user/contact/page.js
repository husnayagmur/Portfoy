...
const page = () => {
  return (
    ...
    >
      <div className=" bg-darkdark-gray bg-opacity-60 w-full h-full flex md:flex-col lg:flex-row space-x-10 p-10">
        <div className="w-full max-w-4xl p-6">
          <div className="w-full lg:h-full md:h-80  overflow-hidden shadow-md">
            <iframe
        ...
        <form className="w-full max-w-lg space-y-10 p-6 font-thin">
          <motion.div
            whileHover={{
              scale: 1.05,
